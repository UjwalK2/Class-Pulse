...
## "Simulate Live Class" Demo Mode (For Hackathon Judging & Testing)

Testing live classroom dynamics solo can be difficult without 30 people in the room. ClassPulse includes a built-in **Live Class Simulator**:

1. **One-Click Activation**: In the Teacher Dashboard, click **"Simulate Class"** to activate 25 simulated student devices sending continuous real-time feedback.
2. **Demo Scenarios**:
   - **Trigger AI (High Confusion)**: Students surge with "Lost" and "Kinda" signals, rapidly elevating the confusion score past 50% to trigger the Gemini AI intervention banner in seconds.
   - **Normal Lecture**: A realistic balanced distribution of signals.
   - **High Mastery**: Simulates high student comprehension ("Got It").
3. **Quick Bursts**: Use **+10 Confusion** or **+10 Got It** to immediately adjust the comprehension gauge on demand.
4. **Auto Diagnostic Voting**: When you click **"Push Diagnostic Live"**, simulated students automatically cast votes (staggered over 3 seconds), animating the live response tally and diagnostic breakdown in real time.
